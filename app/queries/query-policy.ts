...
export const QUERY_POLICY = {
  ...
  organizationReviewerEntry: { staleTime: 15_000, gcTime: 0 },
  organizationReviewerDirectory: { staleTime: 15_000, gcTime: 0 },
  organizationReviewerTarget: { staleTime: 15_000, gcTime: 0 },
  ...
  organizationPermissionCatalog: { staleTime: 30_000, gcTime: QUERY_GC_TIME },
  organizationPermissionBundles: { staleTime: 30_000, gcTime: QUERY_GC_TIME },
