...
const shipBracketIconByGroupId: Readonly<Partial<Record<number, ShipBracketIconName>>> = {
  1022: 'frigate',
  1201: 'battleCruiser',
  1202: 'industrial',
  1283: 'miningFrigate',
...
export function shipBracketIconSource(groupId?: number | null) {
  const icon =
    groupId === null || groupId === undefined ? undefined : shipBracketIconByGroupId[groupId]
