...
describe('environment configuration', () => {
  test('provides safe durable queue defaults', () => {
    ...
    expect(env).toMatchObject({
      ...
      API_SHUTDOWN_TIMEOUT_MS: 30_000,
  ...
  test.each([
    ...
    [
      ...
      { OUTBOX_RELAY_BATCH_SIZE: '11', QUEUE_HIGH_WATER_MARK: '10' },
    ...
    [
      ...
      { OUTBOX_RELAY_CLAIM_TTL_MS: '5000', OUTBOX_RELAY_INTERVAL_MS: '5000' },
    ...
    [
      ...
      { OUTBOX_LAG_DEGRADED_SECONDS: '30', OUTBOX_RELAY_CLAIM_TTL_MS: '30000' },
