...
import type { GetFwLeaderboardsCorporationsResponse } from '@evespace/esi-client/types';

const client = createFactionWarfareClient();

const data: GetFwLeaderboardsCorporationsResponse = await client.getCorporationLeaderboards();
```
...
const data: GetFwLeaderboardsCorporationsResponse = await client.factionWarfare.getCorporationLeaderboards();
```
...
import type { GetFwLeaderboardsCorporationsData, GetFwLeaderboardsCorporationsResponse } from '@evespace/esi-client/types';
...
const data: GetFwLeaderboardsCorporationsResponse = response.data;
```
...
- Request type: `@evespace/esi-client/types` export `GetFwLeaderboardsCorporationsData`
- Request-layer schemas: `headers` uses `@evespace/esi-client/zod` export `zGetFwLeaderboardsCorporationsHeaders`.
- Response type: `@evespace/esi-client/types` export `GetFwLeaderboardsCorporationsResponse`
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/zod` | `zGetFwLeaderboardsCorporationsResponse` | OK |
