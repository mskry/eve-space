...
import type { GetUniverseCategoriesResponse } from '@evespace/esi-client/types';

const client = createUniverseClient();

const data: GetUniverseCategoriesResponse = await client.listItemCategories();
```
...
const data: GetUniverseCategoriesResponse = await client.universe.listItemCategories();
```
...
import type { GetUniverseCategoriesData, GetUniverseCategoriesResponse } from '@evespace/esi-client/types';
...
const data: GetUniverseCategoriesResponse = response.data;
```
...
- Request type: `@evespace/esi-client/types` export `GetUniverseCategoriesData`
- Request-layer schemas: `headers` uses `@evespace/esi-client/zod` export `zGetUniverseCategoriesHeaders`.
- Response type: `@evespace/esi-client/types` export `GetUniverseCategoriesResponse`
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/zod` | `zGetUniverseCategoriesResponse` | OK |
