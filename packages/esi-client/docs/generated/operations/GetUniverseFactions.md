...
import type { GetUniverseFactionsResponse } from '@evespace/esi-client/types';

const client = createUniverseClient();

const data: GetUniverseFactionsResponse = await client.listFactions();
```
...
const data: GetUniverseFactionsResponse = await client.universe.listFactions();
```
...
import type { GetUniverseFactionsData, GetUniverseFactionsResponse } from '@evespace/esi-client/types';
...
const data: GetUniverseFactionsResponse = response.data;
```
...
- Request type: `@evespace/esi-client/types` export `GetUniverseFactionsData`
- Request-layer schemas: `headers` uses `@evespace/esi-client/zod` export `zGetUniverseFactionsHeaders`.
- Response type: `@evespace/esi-client/types` export `GetUniverseFactionsResponse`
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/zod` | `zGetUniverseFactionsResponse` | OK |
