...
import type { GetDogmaAttributesData, GetDogmaAttributesResponse } from '@evespace/esi-client/types';
...
const data: GetDogmaAttributesResponse = response.data;
```
...
- Request type: `@evespace/esi-client/types` export `GetDogmaAttributesData`
- Request-layer schemas: `headers` uses `@evespace/esi-client/zod` export `zGetDogmaAttributesHeaders`.
- Response type: `@evespace/esi-client/types` export `GetDogmaAttributesResponse`
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/zod` | `zGetDogmaAttributesResponse` | OK |
