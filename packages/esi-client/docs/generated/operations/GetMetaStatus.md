...
import type { GetMetaStatusResponse } from '@evespace/esi-client/types';

const client = createMetaClient();

const data: GetMetaStatusResponse = await client.getHealthStatus();
```
...
const data: GetMetaStatusResponse = await client.meta.getHealthStatus();
```
...
import type { GetMetaStatusData, GetMetaStatusResponse } from '@evespace/esi-client/types';
...
const data: GetMetaStatusResponse = response.data;
```
...
- Request type: `@evespace/esi-client/types` export `GetMetaStatusData`
- Request-layer schemas: `headers` uses `@evespace/esi-client/zod` export `zGetMetaStatusHeaders`.
- Response type: `@evespace/esi-client/types` export `GetMetaStatusResponse`
...
| --- | --- | --- | --- | --- |
| `200` | json | `@evespace/esi-client/zod` | `zGetMetaStatusResponse` | OK |
